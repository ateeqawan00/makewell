...
const MbbsVisual = () => {
  return (
    <div className="p-4 mb-4 flex flex-col 900px:flex-row items-center justify-center w-full">
      <div className="flex flex-col gap-4 900px:w-1/2 w-full items-start  ">
        <h1 className="text-[3rem] font-semibold leading-tight w-3/4">
