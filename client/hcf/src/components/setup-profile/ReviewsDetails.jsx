...
import OnBoardingModal from "../../utils/modals/OnBoardingModal";
const myStarStyles = {
...
const ReviewsDetails = ({ setData, data, handleChange, setTab, setActive }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        setLoading(true);
        const res = await axiosInstance.post("/hcf/signup", {
          ...data,
          review: { ...values },
        });
      ...
      document.getElementById("onBoardModal").showModal();
    },
  });

  return (
    <div className="w-full mx-auto p-4 md:p-8 rounded-lg bg-white">
      <OnBoardingModal setActive={setActive} setTab={setTab} />
      ...
      <div className="flex gap-2 flex-col mt-2 w-full">
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <button
            onClick={(e) => {
              e.preventDefault();
              setData({ ...data, review: { ...formik.values } });
              console.log(data);
            }}
