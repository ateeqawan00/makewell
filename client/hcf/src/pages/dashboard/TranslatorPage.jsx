  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between w-full">
        <h1 className="text-primary font-semibold text-xl mx-auto 700px:m-0">Home</h1>
      ...
      <div className="w-full p-4 flex flex-col gap-3">
        {caseData.map((item, index) => (
          <div className="flex items-center p-2 rounded-lg shadow-lg max-w-[900px] flex-wrap 500px:flex-nowrap"  key={index + 0.023 * 2}>
            <img
              src={item.imgUrl}
              alt="case image"
              className="w-[150px]"
