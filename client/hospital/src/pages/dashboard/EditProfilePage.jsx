...
const SignUp = () => {
  ...
  return (
    <div className="max-w-lg mx-auto p-8 bg-white rounded-lg shadow-md">
      ...
      <div>
        <p className="text-left mb-1 text-sm text-zinc-600 ">
      ...
      <form>
        ...
        <div className="flex flex-col items-end w-[100%] ">
          <button
            className="bg-primary hover:bg-primary/75 text-white font-bold py-2 px-4 w-[60%]  rounded-3xl focus:outline-none focus:shadow-outline"
            type="submit"
          >
            Save
          </button>
